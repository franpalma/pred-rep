...
boxplot(dt1, dt2, dt3, dt4, dt5, dt6, names=c("ST","MC","CMC","TM","Traditional","Traditional2"), ylab="% TCs to be executed for finding the first failing TC", col="white", cex.lab=.85, cex.axis=.85, las=2)
...
boxplot(dt1, dt2, dt3, names=c("Traditional","Similarity","Similarity2"), ylab="% TCs to be executed for finding the first failing TC", col="white", cex.lab=.85, cex.axis=.85, las=2)
